...
/* Definitions for driver MPL */
#define XPAR_MPL_NUM_INSTANCES 1

/* Definitions for peripheral MPL_0 */
#define XPAR_MPL_0_DEVICE_ID 0
#define XPAR_MPL_0_S00_AXI_BASEADDR 0x43C00000
#define XPAR_MPL_0_S00_AXI_HIGHADDR 0x43C0FFFF
