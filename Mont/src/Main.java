...
public class Main {
	...
	public static void expTest(){
		...
		exponenciacionModular(x, exp, p , size , k);
	}	

	//Full modular exponentiation
	public static BigInteger exponenciacionModular(BigInteger x, BigInteger exp , BigInteger p , int size , int k){
	...
	public static void expTestFixedValues(){
		...
		exponenciacionModular(g, exp, p, size, k);	
	}
